...
#define	shades(n, l)		saturate(dot(n, l))
    ...
    q4.xyz = ((GetLightAmount(IN.texcoord_6, IN.texcoord_7, IN.ShadowNearFar.x, IN.ShadowNearFar.y) * (shades(r1.xyz, m23.xyz) * PSLightColor[0].rgb)) + AmbientColor.rgb) * q3.xyz;
