...
#define	shades(n, l)		saturate(dot(n, l))
    ...
    r0.xyz = (GetLightAmount(IN.texcoord_6, IN.texcoord_7, IN.ShadowNearFar.x, IN.ShadowNearFar.y) * (shades(normalize(q1.xyz), m29.xyz) * PSLightColor[0].rgb)) + AmbientColor.rgb;
