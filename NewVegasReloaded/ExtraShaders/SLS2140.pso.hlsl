...
#define	shades(n, l)		saturate(dot(n, l))
    ...
    q7.xyz = ((GetLightAmount(IN.texcoord_6, IN.texcoord_7, IN.ShadowNearFar.x, IN.ShadowNearFar.y) * (r7.w * PSLightColor[0].rgb)) + AmbientColor.rgb) * ((IN.LCOLOR_1.w * r13.xyz) + q6.xyz);
