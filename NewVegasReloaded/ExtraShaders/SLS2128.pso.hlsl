...
#define	shades(n, l)		saturate(dot(n, l))
    ...
    q10.xyz = ((GetLightAmount(IN.texcoord_6, IN.texcoord_7, IN.ShadowNearFar.x, IN.ShadowNearFar.y) * q24.xyz) + AmbientColor.rgb) * ((IN.LCOLOR_1.y * r9.xyz) + ((IN.LCOLOR_1.x * r8.xyz) + q9.xyz));
